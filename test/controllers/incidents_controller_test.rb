...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { npws: @incident.npws, officer: @incident.officer, reason: @incident.reason, whenfound: @incident.whenfound, wherefound: @incident.wherefound }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { npws: @incident.npws, officer: @incident.officer, reason: @incident.reason, whenfound: @incident.whenfound, wherefound: @incident.wherefound }
    assert_redirected_to incident_path(assigns(:incident))
  end
